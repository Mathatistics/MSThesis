...
\usepackage{bm}
\usetikzlibrary{plotmarks,arrows, shapes, calc, backgrounds, fit, decorations.markings, shadows}
\addbibresource{reference.bib}

% Loading R Packages
<<LoadingPkgs, echo=FALSE, message=FALSE, warning=FALSE, results='hide'>>=
req.package<-c("pls", "xtable", "MASS", "car", "corrplot", "gdata", "dplyr", "ggplot2", "reshape2","ridge", "grid", "gridExtra", "stargazer", "devtools", "ggbiplot", "mixlm", "Hmisc", "knitr", "leaps", "rockchalk")
